...
`LexiconMining.jl` is an unpublished Julia package to extract latent morphological data and short definitions from a digital edition of Lewis-Short's *Latin Dictionary*, and format it for use with the Tabulae system for building Latin morphological parsers.
